...
def visualize(image, noisy_image, GT, pred_mask, anomaly_map, result_save_dir, category) :
    for idx, img in enumerate(image):
        ...
        plt.savefig(f'{result_save_dir}/sample{idx}.png')
        plt.close()
        ...
        plt.title('heat map')
        plt.savefig(f'{result_save_dir}/sample{idx}heatmap.png')
        plt.close()
